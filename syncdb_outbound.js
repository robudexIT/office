...
const syncdb = async (query) => {
    try {
        ...
        //  let countph = phcdrs[0].length
         ...
         query = `SELECT * FROM tblSBTCallDetails_AddressBook WHERE CdtURL='http://192.168.45.110/callrecording/outgoing/20230207/6318-010243814628236-20230207-004229.mp3';`
